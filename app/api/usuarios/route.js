...
export async function GET(request) {
    ...
    if(reservados||!regEx||query.trim()===""){ return Response.json({response:false,mensagem:"Nome de usuario ou caracteres não permitidos (usuarios só podem conter letras, números, underscore e pontos.)"}) }
