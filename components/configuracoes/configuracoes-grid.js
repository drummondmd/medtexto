      ...
      {toast.isActive && (
        <div className="position-fixed top-0 end-0 p-3" style={{ zIndex: 1050 }}>
          ...
          >
            ...
            <div className="toast-body">{toast.mensagem}</div>
          </div>
        </div>
      )}
          ...
          <div className="fade show active" role="tabpanel">
            ...
            <div className="card shadow-sm border-0 rounded-3 border-danger border-opacity-25">
              <div className="card-body p-4">
                ...
                <p className="card-text text-muted mb-4">
                  Se deseja excluir sua conta e apagar todos dados salvos, digite &quot;Deletar
                  conta&quot;
                </p>
          ...
          <div className="fade show active" role="tabpanel">
            <div className="card shadow-sm border-0 rounded-3">
              <div className="card-body p-4">
                ...
                <Link href={`/${userNameSlug}/contato`} className="btn btn-primary">
