    ...
    function ModalMenu() {
        return (
            <div className="d-lg-none">
                <div className="position-fixed top-0 start-0 w-100 h-100 bg-dark bg-opacity-50" style={{ zIndex: 1050 }} onClick={closeModal}>
                    <div className={`${classes.sidebar} d-lg-none rounded bg-light p-2 mt-4`} style={{ width: '250px', height: '100%', overflowY: 'auto' }} onClick={(e) => e.stopPropagation()}>
                        {listItem}
                    </div>
                </div>
    ...
    return (
        <>
            ...
            <div className={`col-lg-2 d-none d-lg-block`}>
                <div className={`${classes.sidebar} p-2 mt-4`}>
                    {listItem}
                </div>
            </div>
