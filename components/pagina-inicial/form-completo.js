    ...
    <div className="container my-4 ">
      ...
      <form className="row g-3" action={formAction}>
        ...
        <div className="col-md-4">
          ...
          <input type="date" className="form-control" name="data_nascimento" defaultValue={state ? state.payload.get("data_nascimento") : stringDate} />
        </div>
        ...
        {/* Local de trabalho */}
        <div className="col-md-12">
          <label className="form-label">Local de trabalho(Se mais de 1, considere maior carga horária)</label>
          <input type="text" className="form-control" name="local_trabalho" defaultValue={state ? state.payload.get("local_trabalho") : userDetail.local_trabalho} />
        </div>
