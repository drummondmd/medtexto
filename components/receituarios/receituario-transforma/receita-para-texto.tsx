        ...
        <div className="container">
            <div className="my-2">
                ...
                <div className="d-inline">
                    <button onClick={handleTransform} type="button" className="btn btn-secondary mx-1" >Transformar</button>
                    <button type="button" className="btn btn-secondary mx-1" >Apagar</button>
                    {copiado && <span className="text-green-400">Copiado!<ClipboardCheck size={"18px"} color="oklch(72.3% 0.219 149.579)" /></span>}
                </div>
            </div>
            <div className="my-2">
                <textarea title="clique para copiar"
                    value={texto}
