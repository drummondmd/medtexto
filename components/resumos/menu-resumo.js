...
export default function MenuResumo({ cadernosJson, userNameSlug, userDetail }) {
    ...
    return (
        <>
            {modal && <CreateNota recurso={"resumo"} isCaderno={true} cadernos={cadernos} handlerForm={createResumoForm} boolean={true} close={() => setModal(false)} user={userDetail} />}
                            ...
                            return (
                                <li className="list-group-item" key={elem["_id"]}>
                                    <div className="p-1 d-flex justify-content-between">
                                        ...
                                        <div role="buttom" className=" btn d-flex" onClick={() => resumoHandle("caderno", "delete-caderno", "resumos", userDetail, elem._id)}>
