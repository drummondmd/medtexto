    ...
    <>
      <div className="d-flex justify-content-end mb-2">
        <div
          ...
          onClick={() => navigator.clipboard.writeText(nota.conteudo)}
        >
          Copiar
        </div>
        <div
          onClick={() =>
            resumoHandle("note", "delete", "resumos", user, cadernoId, nota, userNameSlug)
          }
          role="buttom"
        ...
        <div
          onClick={() =>
            resumoHandle("note", "update", "resumos", user, cadernoId, nota, userNameSlug)
          }
