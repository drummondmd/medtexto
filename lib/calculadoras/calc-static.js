export const calculadorasEstaticas = [
  {
  ...
  },
  {
    ...
    descricao: 'Esta fórmula estima a área total da superfície externa de um indivíduo, auxiliando no cálculo de dosagens de medicamentos, como quimioterapia, e na medição do índice cardíaco.'
  },
  {
  ...
  {
    titulo: 'FENa (Frações Excretadas de Sódio)',
    slug: 'fena',
    descricao: 'Determina se a insuficiência renal é devida a patologia pré-renal ou intrínseca.'
  },
  {
    titulo: 'Child-Pugh',
    slug: 'child-pugh',
