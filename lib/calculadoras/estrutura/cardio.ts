...
const hasBled:CalculadoraEstrutura =
{
  ...
  "descricao": "O HAS-BLED é utilizado para estimar o risco de sangramento maior em pacientes com fibrilação atrial, especialmente aqueles em uso de anticoagulantes. ",
  "instrucoes": " Para usar o HAS-BLED, avalie fatores clínicos do paciente com fibrilação atrial, atribua 1 ponto para cada fator presente, some os pontos e interprete o risco de sangramento anual; ≥3 indica alto risco e necessidade de monitorização mais rigorosa",
  "entradas": [
    {
      "nome": "Hipertensão",
      "inputType": "select",
  ...
  "evidencia": "O HAS-BLED é composto por sete itens: hipertensão, função renal ou hepática anormal, história de AVC, história ou predisposição a sangramento, INR lábil, idade ≥65 anos, uso concomitante de drogas ou álcool. Cada item vale 1 ponto; a soma final indica o risco de sangramento anual",
  "referencias": [
    {
      ...
      "descricao": "A novel user-friendly score (HAS-BLED) to assess 1-year risk of major bleeding in atrial fibrillation patients.",
...
const heartScore:CalculadoraEstrutura =
{
  ...
  "calculadorasRelacionadas": [],
  "evidencia": "A fórmula consiste em somar pontos (0, 1 ou 2) para cada um dos cinco componentes: História clínica, ECG, Idade, Fatores de risco e Troponina. O total varia de 0 a 10, sendo que quanto maior o valor, maior o risco de eventos cardíacos.",
  "referencias": [
    {
