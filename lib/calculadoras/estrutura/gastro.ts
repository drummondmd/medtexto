...
const lille: CalculadoraEstrutura =
{
    ...
    "instrucoes": "Use valores laboratoriais de bilirrubina antes e após 7 dias, albumina, creatinina e idade.",
    "entradas": [
        {
            "nome": "Idade",
            "inputType": "input",
