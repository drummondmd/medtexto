...
const superficieCorporal: CalculadoraEstrutura = {
    ...
    referencias: [
        {
            titulo: "A formula to estimate the approximate surface area if height and weight be known. 1916",
...
const imc: CalculadoraEstrutura = {
    ...
    referencias: [
        {
            titulo: "\"How much should I weigh?\"--Quetelet's equation, upper weight limits, and BMI prime",
