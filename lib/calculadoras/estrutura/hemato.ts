...
const defictFerro: CalculadoraEstrutura = {
    ...
    entradas: [
        ...
        },
        {
            ...
            tipo: "select",
            entradas: [
                { tipo: "radio", nome:"Sacarato de óxido férrico(Noripurum)",value:"noripurum",isDefault:true }
            ]
    ...
    referencias: [
        {
            ...
            descricao:
                "Therapeutic use of IV iron dextran based on total iron deficit calculations.",
