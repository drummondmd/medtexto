...
const ckdEpi: CalculadoraEstrutura = {
  ...
  instrucoes:
    "Para usar a fórmula CKD-EPI, utilize creatinina sérica , idade, sexo e raça. A equação é indicada para adultos, com valores laboratoriais calibrados, e estima o ritmo de filtração glomerular em mL/min/1,73m²",
  entradas: [
    {
      nome: "Creatinina",
      inputType: "input",
  ...
  slug: "ckd-epi",
  calculadorasRelacionadas: [{ id: "67f42b1e599cb9587779a1b6" }],
...
const cockcroftGault: CalculadoraEstrutura = {
  ...
  instrucoes:
    "Para usar a fórmula Cockcroft-Gault, utilize idade, peso, creatinina sérica e sexo para estimar a depuração de creatinina em adultos. Prefira peso ajustado se o paciente for obeso. Não é recomendada para crianças ou pacientes com função renal instável",
  entradas: [
    {
      nome: "Creatinina",
      inputType: "input",
  ...
  calculadorasRelacionadas: [{ id: "67f42b1e599cb9587779a1b7" }],
