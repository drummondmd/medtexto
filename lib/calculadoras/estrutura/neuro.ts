...
const ecg: CalculadoraEstrutura = {
  ...
  instrucoes:
    "Projetado para uso em avaliações seriadas de pacientes em coma por causas médicas ou cirúrgicas por ser amplamente aplicável.",
  entradas: [
    {
  ...
  evidencia:
    " Escala de Coma da Glasgow é calculado pela adição dos pontos totais selecionados em cada componente (olho, verbal, motor)",
  referencias: [
    {
