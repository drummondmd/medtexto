...
const curb65: CalculadoraEstrutura = {
  ...
  descricao:
    "Estima a mortalidade da pneumonia adquirida na comunidade para ajudar a determinar o tratamento hospitalar versus ambulatorial.",
  instrucoes:
    "A calculadora CURB-65 pode ser usada no pronto-socorro para estratificar o risco de pneumonia adquirida na comunidade de um paciente.",
  entradas: [
    {
      nome: "confusao",
  ...
  calculadorasRelacionadas: [{ id: "67f433ea599cb9587779a1cb" }],
...
const wellsTep: CalculadoraEstrutura = {
  ...
  instrucoes:
    'Avalie fatores clínicos de risco, some os pontos atribuídos a cada critério e estratifique a probabilidade de tromboembolismo pulmonar em baixa, moderada ou alta, ou em "PE improvável" e "PE provável" para orientar a investigação diagnóstica',
  entradas: [
    {
      nome: "tvp",
  ...
  calculadorasRelacionadas: [{ id: "67f432af599cb9587779a1bf" }],
  evidencia:
    " • 0–1: baixa probabilidade • 2–6: moderada • >6: alta Ou: • 0–4: TEP improvável • >4: TEP provável",
  referencias: [
    {
      titulo:
...
const psiPort: CalculadoraEstrutura = {
  ...
  instrucoes:
    "O escore PSI/PORT pode ser usado na clínica ou no pronto-socorro para estratificar o risco de pneumonia adquirida na comunidade de um paciente.",
  entradas: [
    {
      nome: "Idade",
      inputType: "input",
  ...
  calculadorasRelacionadas: [{ id: "67f432af599cb9587779a1c1" }],
...
const wellsTvp: CalculadoraEstrutura = {
  ...
  calculadorasRelacionadas: [{ id: "67f43275599cb9587779a1bc" }],
