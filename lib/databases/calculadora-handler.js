...
const dataTest = [
  {
    ...
    calculadorasRelacionadas: [
        ...
        entradas: [
          {
            ...
            tipo: "number",
            unidade: "mg/dL",
            placeholder: "Normal 0,7-1",
            obs: "Creatinina sérica",
          },
          {
            nome: "Idade",
            inputType: "input",
          ...
          },
          {
            ...
            inputType: "select",
            entradas: [
              { tipo: "radio", nome: "Masculino" },
              { tipo: "radio", nome: "Feminino" },
            ],
          ...
          },
          {
            ...
            inputType: "select",
            entradas: [
              { tipo: "radio", nome: "Negro" },
              { tipo: "radio", nome: "Não negro" },
            ],
            obs: "Negra ou não negra",
          },
        ],
      ...
      },
      {
        ...
        instrucoes:
          "Utilize com cautela em pacientes com condições que afetam bilirrubina ou albumina.",
        entradas: [
          {
            nome: "Bilirrubina",
            inputType: "input",
          ...
          },
          {
            ...
            unidade: "",
            placeholder: "",
            obs: "Relação normalizada internacional",
          },
          {
            nome: "Ascite",
            inputType: "select",
            entradas: [
              { tipo: "radio", nome: "Nenhuma", value: 1 },
              { tipo: "radio", nome: "Leve", value: 2 },
              { tipo: "radio", nome: "Moderada", value: 3 },
            ],
            obs: "",
          },
          {
...
async function calculadoraEspecifica(calculadoraSlug) {
  try {
    const calcEscolhida = dataTest.filter((elem) => elem.link === calculadoraSlug);
