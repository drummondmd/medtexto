...
async function getUser(userName, email) {
  console.log("Tentando conectar com a URL:", process.env.POSTGRES_URL)
  console.log("Tentando conectar com a host:", process.env.POSTGRES_HOST)
  console.log("Tentando conectar com a database:", process.env.POSTGRES_DATABASE)
  console.log("Tentando conectar com a password:", process.env.POSTGRES_PASSWORD)
