...
type TUsuarioDocument = InferSchemaType<typeof UsuarioMongoSchema>;
export type UsuarioModelType = Model<TUsuarioDocument>;

const UsuarioMongo: UsuarioModelType =
  (mongoose.models.UsuarioMongo as UsuarioModelType) ||
  mongoose.model<TUsuarioDocument>("UsuarioMongo", UsuarioMongoSchema);
/// Calculadoras
...
const CalculadoraSchema = new mongoose.Schema({
  ...
  calculadorasRelacionadas: [
    { type: mongoose.Schema.Types.ObjectId, ref: "Calculadora", default: [] },
  ],
  evidencia: String,
